...
hooks:
  PreToolUse:
    - matcher: 'Edit|MultiEdit|Write'
      hooks:
        - type: command
          command: 'LAYER_PATHS=packages/config:packages/utils:configs LAYER_FILES=tsconfig.json:vitest.config.ts "$CLAUDE_PROJECT_DIR"/.claude/hooks/layer-scope-guard.sh'
---
