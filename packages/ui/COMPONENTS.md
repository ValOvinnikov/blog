...
Props: items: T[] · renderItem: (item: T, index: number) => ReactNode · ariaLabel: string · previousLabel: string · nextLabel: string · slideSize?: TCarouselVariants['slideSize'] _(extends IWithClassName, IWithDataTestId)_
