...
export const iconButtonVariants = tv({
  base: [
    ...
    // `bg-surface-2` alone reads as near-invisible here (page `--bg` vs
    ...
    // against `--bg` directly — light 3.54:1, dark 3.94:1.
    'hover:border-border-emphasis hover:bg-surface-2 hover:text-text',
    'cursor-pointer',
    'focus-visible:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent',
