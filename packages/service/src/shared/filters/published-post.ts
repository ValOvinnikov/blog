 ...
 * `content`, and `seo`. Chain this raw GROQ condition alongside
...
export const PUBLISHED_POST_FILTER =
  'publishedAt <= now() && defined(headingBlock.heading) && defined(author) && defined(topic) && defined(content) && defined(seo)';
