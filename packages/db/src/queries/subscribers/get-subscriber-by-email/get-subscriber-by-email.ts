...
// email, without attempting a write — a lightweight pre-check
// `NewsletterForm` (#1104) can use for an inline "already subscribed"
// validation (e.g. on blur) ahead of a real submit, separate from
// `createPendingSubscriber`'s own built-in duplicate handling on the submit
// path itself.
//
