 ...
 * runs, leaving `tenants.sanityProjectId` populated as the signal that this
 * archived tenant's Sanity project needs manual deletion by someone with
 * that permission. Any other failure still throws and stops the run.
 */
