...
/**
 * Step 4 — clears the persisted (encrypted) Sanity read/write tokens and
 * every other provisioning-artifact column on the `tenants` row, now that
 * the external resources they pointed at are gone. `sanityProjectId` and
