/**
 * Folds `page_topic.postList` into `modules[]` as a `module_postList`
...
export type TPageTopicDoc = {
  postList?: { _ref?: string };
  modules?: TModuleReferenceItem[];
};

export const foldPostListIntoModules = (doc: TPageTopicDoc) => {
...
export default defineMigration({
  title: 'Fold page_topic.postList into modules[]',
  documentTypes: ['page_topic'],
  migrate: {
    document(doc) {
      return foldPostListIntoModules(doc as unknown as TPageTopicDoc);
    },
  },
});
