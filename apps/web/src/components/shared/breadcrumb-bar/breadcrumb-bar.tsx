 ...
 * (1120px), even on pages whose own `<main>` is narrower (e.g. the ~620px
 * post-detail body, capped at the `max-w-measure` reading-width token) — a
 * uniform chrome band regardless of the page's own content width. Home
 * renders no bar.
 *
 * @example
 * <BreadcrumbBar>
