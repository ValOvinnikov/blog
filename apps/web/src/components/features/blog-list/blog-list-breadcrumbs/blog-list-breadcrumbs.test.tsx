...
import { BlogListBreadcrumbs } from './blog-list-breadcrumbs';
...
const setup = customRenderAsync(BlogListBreadcrumbs, { tenant: 'tenant-1' });

describe(`<${BlogListBreadcrumbs.name}/>`, () => {
  beforeEach(() => {
  ...
  it('renders the JSON-LD BreadcrumbList schema script', async () => {
    ...
    expect(script?.textContent).toContain('"item":"https://example.com/blog"');
  });
