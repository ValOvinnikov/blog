...
| ---------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `@blog/config`   | `utils`, `@portabletext/types` (types only)                                                                         | Constants (UPPERCASE key/value pairs) — cross-cutting ones only; a storage layer's own vocabulary lives with that layer, see `@blog/db` — the `routes` URL builder (single source of URL truth) and `pageHref`, the page-type → path resolver both `service`'s link transformer and the Studio's action previews use, generated Sanity types + extracted schema, shared TS types, `/react` subpath for polymorphic prop helpers, and (alongside `PRESET_REGISTRY`) the WCAG AA `isAccentHueAccessible` accent-hue contrast guard and `resolveTenantEmailBrand`, which runs the same OKLCH recipes `apps/web` renders as CSS to return literal hex for `@blog/email`'s tenant shell. Also `TPortableText` — the one resolved Portable Text block type, built on `@portabletext/types`' `PortableTextBlock` with an `IPortableTextLinkMark` (`_type: 'linkRef'`) mark — imported by both `service` and `web`. Style and list narrowing is the schema's job (`inlineText`, `proseText`, `richText`), not the type's                                                                                                                                                                                                                                                                                  | contain app logic; force React on non-React consumers (subpath!)                                                                                                                                                                                                         |
