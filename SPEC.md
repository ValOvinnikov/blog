...
| ---------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `@blog/config`   | `utils`                                                                                                             | Constants (UPPERCASE key/value pairs) — cross-cutting ones only; a storage layer's own vocabulary lives with that layer, see `@blog/db` — the `routes` URL builder (single source of URL truth), generated Sanity types + extracted schema, shared TS types, `/react` subpath for polymorphic prop helpers, and (alongside `PRESET_REGISTRY`) the WCAG AA `isAccentHueAccessible` accent-hue contrast guard and `resolveTenantEmailBrand`, which runs the same OKLCH recipes `apps/web` renders as CSS to return literal hex for `@blog/email`'s tenant shell                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | contain app logic; force React on non-React consumers (subpath!)                                                                                                                                                                                                         |
